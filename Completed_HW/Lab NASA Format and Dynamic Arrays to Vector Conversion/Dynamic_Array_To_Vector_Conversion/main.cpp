 ...
 * 
 * I believe the fill functions aren't working for some reason.
 * 
 * ------BROKEN--------
 * 
 */
...
vector<int>  fillAry(vector<int>,int,int,int);
vector<vector<int>>  fillAry(vector<vector<int>>,int,int);
...
vector<int> fillAry(vector<int> a, int n,int hr,int lr){
    n=n<2?2:n;
...
vector<vector<int>> fillAry(vector<vector<int>> a,int rows,int cols){
